...
This collection was migrated from `Bravecold/PowerShell` so the scripts and related course material can be maintained together. The original Spanish course notes remain available in [Module1.md](Module1.md).
...
For naming conventions, platform and safety checks, documentation requirements, and secret-handling guidance, see the [script catalog and maintenance guide](Docs/SCRIPT-CATALOG.md).
