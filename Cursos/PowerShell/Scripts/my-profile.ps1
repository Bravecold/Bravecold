<#
.SYNOPSIS
	Configures an opinionated interactive PowerShell profile
.DESCRIPTION
	Sets the terminal title and prompt, then defines convenience aliases for common navigation commands.
	The aliases that reference scripts require the repository's Scripts directory to be available on PATH.
.EXAMPLE
	PS> . ./my-profile.ps1
.LINK
